...
public class Utility {
    ...
    public Utility(String type, String start, String end, double amount,int people){
        billType=type;
        billStartDate=start;
        billEndDate=end;
        billAmount=amount;
    ...
    public Double getTotalEmission() {
            ...
            return totalEmission/5.965;//a tree absorbs as much as 48 pounds/21.7724 kg of CO2 a year, 21.7724/365/24
    }
